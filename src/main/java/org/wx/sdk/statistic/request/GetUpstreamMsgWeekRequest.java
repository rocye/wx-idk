 ...
 * @version 2017-10-09
 */
public class GetUpstreamMsgWeekRequest implements Request<GetUpstreamMsgWeekRespone> {
     ...
     * 构造函数
     */
    public GetUpstreamMsgWeekRequest() {
     ...
     */
    public GetUpstreamMsgWeekRequest(String beginDate, String endDate) {
    ...
    public String getApiUrl(){
        String url = "https://api.weixin.qq.com/datacube/getupstreammsgweek?access_token="+ this.accessToken;
        return url;
    }
     ...
     * 获取返回对象类
     */
    public Class<GetUpstreamMsgWeekRespone> getResponseClass(){
        return GetUpstreamMsgWeekRespone.class;
    }
