 ...
 * @version 2017-10-09
 */
public class GetUpstreamMsgHourRequest implements Request<GetUpstreamMsgHourRespone> {
     ...
     * 构造函数
     */
    public GetUpstreamMsgHourRequest() {
     ...
     */
    public GetUpstreamMsgHourRequest(String beginDate, String endDate) {
    ...
    public String getApiUrl(){
        String url = "https://api.weixin.qq.com/datacube/getupstreammsghour?access_token="+ this.accessToken;
        return url;
    }
     ...
     * 获取返回对象类
     */
    public Class<GetUpstreamMsgHourRespone> getResponseClass(){
        return GetUpstreamMsgHourRespone.class;
    }
