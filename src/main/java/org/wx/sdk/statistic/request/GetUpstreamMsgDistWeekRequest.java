 ...
 * @version 2017-10-09
 */
public class GetUpstreamMsgDistWeekRequest implements Request<GetUpstreamMsgDistWeekRespone> {
     ...
     * 构造函数
     */
    public GetUpstreamMsgDistWeekRequest() {
     ...
     */
    public GetUpstreamMsgDistWeekRequest(String beginDate, String endDate) {
    ...
    public String getApiUrl(){
        String url = "https://api.weixin.qq.com/datacube/getupstreammsgdistweek?access_token="+ this.accessToken;
        return url;
    }
     ...
     * 获取返回对象类
     */
    public Class<GetUpstreamMsgDistWeekRespone> getResponseClass(){
        return GetUpstreamMsgDistWeekRespone.class;
    }
