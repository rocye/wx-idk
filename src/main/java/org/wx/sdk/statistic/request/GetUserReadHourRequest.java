 ...
 * @version 2017-09-30
 */
public class GetUserReadHourRequest implements Request<GetUserReadHourRespone> {
     ...
     */
    public GetUserReadHourRequest(String beginDate, String endDate) {
    ...
    public String getApiUrl(){
        String url = "https://api.weixin.qq.com/datacube/getuserreadhour?access_token="+ this.accessToken;
        return url;
    }
     ...
     * 获取返回对象类
     */
    public Class<GetUserReadHourRespone> getResponseClass(){
        return GetUserReadHourRespone.class;
    }
