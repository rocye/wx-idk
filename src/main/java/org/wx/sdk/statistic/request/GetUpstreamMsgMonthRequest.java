 ...
 * @version 2017-10-09
 */
public class GetUpstreamMsgMonthRequest implements Request<GetUpstreamMsgMonthRespone> {
     ...
     * 构造函数
     */
    public GetUpstreamMsgMonthRequest() {
     ...
     */
    public GetUpstreamMsgMonthRequest(String beginDate, String endDate) {
    ...
    public String getApiUrl(){
        String url = "https://api.weixin.qq.com/datacube/getupstreammsgmonth?access_token="+ this.accessToken;
        return url;
    }
     ...
     * 获取返回对象类
     */
    public Class<GetUpstreamMsgMonthRespone> getResponseClass(){
        return GetUpstreamMsgMonthRespone.class;
    }
