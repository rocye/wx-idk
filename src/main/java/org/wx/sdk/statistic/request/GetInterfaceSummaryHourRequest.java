 ...
 * @version 2017-10-09
 */
public class GetInterfaceSummaryHourRequest implements Request<GetInterfaceSummaryHourRespone> {
     ...
     * 构造函数
     */
    public GetInterfaceSummaryHourRequest() {
     ...
     */
    public GetInterfaceSummaryHourRequest(String beginDate, String endDate) {
    ...
    public String getApiUrl(){
        String url = "https://api.weixin.qq.com/datacube/getinterfacesummaryhour?access_token="+ this.accessToken;
        return url;
    }
     ...
     * 获取返回对象类
     */
    public Class<GetInterfaceSummaryHourRespone> getResponseClass(){
        return GetInterfaceSummaryHourRespone.class;
    }
