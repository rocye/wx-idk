 ...
 * @version 2017-09-29
 */
public class GetUserReadRequest implements Request<GetUserReadRespone> {
     ...
     */
    public GetUserReadRequest(String beginDate, String endDate) {
    ...
    public String getApiUrl(){
        String url = "https://api.weixin.qq.com/datacube/getuserread?access_token="+ this.accessToken;
        return url;
    }
     ...
     * 获取返回对象类
     */
    public Class<GetUserReadRespone> getResponseClass(){
        return GetUserReadRespone.class;
    }
