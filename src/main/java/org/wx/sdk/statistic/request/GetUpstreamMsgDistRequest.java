 ...
 * @version 2017-10-09
 */
public class GetUpstreamMsgDistRequest implements Request<GetUpstreamMsgDistRespone> {
     ...
     * 构造函数
     */
    public GetUpstreamMsgDistRequest() {
     ...
     */
    public GetUpstreamMsgDistRequest(String beginDate, String endDate) {
    ...
    public String getApiUrl(){
        String url = "https://api.weixin.qq.com/datacube/getupstreammsgdist?access_token="+ this.accessToken;
        return url;
    }
     ...
     * 获取返回对象类
     */
    public Class<GetUpstreamMsgDistRespone> getResponseClass(){
        return GetUpstreamMsgDistRespone.class;
    }
