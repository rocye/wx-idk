 ...
 * @version 2017-09-30
 */
public class GetUserShareRequest implements Request<GetUserShareRespone> {
     ...
     */
    public GetUserShareRequest(String beginDate, String endDate) {
    ...
    public String getApiUrl(){
        String url = "https://api.weixin.qq.com/datacube/getusershare?access_token="+ this.accessToken;
        return url;
    }
     ...
     * 获取返回对象类
     */
    public Class<GetUserShareRespone> getResponseClass(){
        return GetUserShareRespone.class;
    }
