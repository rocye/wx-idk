 ...
 * @version 2017-09-25
 */
public class GetUserCumulateRequest implements Request<GetUserCumulateRespone> {
     ...
     */
    public GetUserCumulateRequest(String beginDate, String endDate) {
    ...
    public String getApiUrl(){
        String url = "https://api.weixin.qq.com/datacube/getusercumulate?access_token="+ this.accessToken;
        return url;
    }
     ...
     * 获取返回对象类
     */
    public Class<GetUserCumulateRespone> getResponseClass(){
        return GetUserCumulateRespone.class;
    }
