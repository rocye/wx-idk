 ...
 * @version 2017-10-09
 */
public class GetUpstreamMsgRequest implements Request<GetUpstreamMsgRespone> {
     ...
     */
    public GetUpstreamMsgRequest(String beginDate, String endDate) {
    ...
    public String getApiUrl(){
        String url = "https://api.weixin.qq.com/datacube/getupstreammsg?access_token="+ this.accessToken;
        return url;
    }
     ...
     * 获取返回对象类
     */
    public Class<GetUpstreamMsgRespone> getResponseClass(){
        return GetUpstreamMsgRespone.class;
    }
