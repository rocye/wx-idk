 ...
 * @version 2017-10-09
 */
public class GetUpstreamMsgDistMonthRequest implements Request<GetUpstreamMsgDistMonthRespone> {
     ...
     * 构造函数
     */
    public GetUpstreamMsgDistMonthRequest() {
     ...
     */
    public GetUpstreamMsgDistMonthRequest(String beginDate, String endDate) {
    ...
    public String getApiUrl(){
        String url = "https://api.weixin.qq.com/datacube/getupstreammsgdistmonth?access_token="+ this.accessToken;
        return url;
    }
     ...
     * 获取返回对象类
     */
    public Class<GetUpstreamMsgDistMonthRespone> getResponseClass(){
        return GetUpstreamMsgDistMonthRespone.class;
    }
