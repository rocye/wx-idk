 ...
 * @version 2017-10-09
 */
public class GetInterfaceSummaryRequest implements Request<GetInterfaceSummaryRespone> {
     ...
     * 构造函数
     */
    public GetInterfaceSummaryRequest() {
     ...
     */
    public GetInterfaceSummaryRequest(String beginDate, String endDate) {
    ...
    public String getApiUrl(){
        String url = "https://api.weixin.qq.com/datacube/getinterfacesummary?access_token="+ this.accessToken;
        return url;
    }
     ...
     * 获取返回对象类
     */
    public Class<GetInterfaceSummaryRespone> getResponseClass(){
        return GetInterfaceSummaryRespone.class;
    }
