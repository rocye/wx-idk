...
/**
 * <p>获取图文群发每日数据(最大时间跨度:1)
 * <p>获取的是某天所有被阅读过的文章（仅包括群发的文章）在当天的阅读次数等数据。
 * 
 ...
 * @version 2017-09-29
 */
public class GetArticleSummaryRequest implements Request<GetArticleSummaryRespone> {
     ...
     * 构造函数
     */
    public GetArticleSummaryRequest() {
     ...
     */
    public GetArticleSummaryRequest(String beginDate, String endDate) {
    ...
    public String getApiUrl(){
        String url = "https://api.weixin.qq.com/datacube/getarticlesummary?access_token="+ this.accessToken;
        return url;
    }
     ...
     * 获取返回对象类
     */
    public Class<GetArticleSummaryRespone> getResponseClass(){
        return GetArticleSummaryRespone.class;
    }
