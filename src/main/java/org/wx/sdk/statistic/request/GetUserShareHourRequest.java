 ...
 * @version 2017-09-30
 */
public class GetUserShareHourRequest implements Request<GetUserShareHourRespone> {
     ...
     * 构造函数
     */
    public GetUserShareHourRequest() {
     ...
     */
    public GetUserShareHourRequest(String beginDate, String endDate) {
    ...
    public String getApiUrl(){
        String url = "https://api.weixin.qq.com/datacube/getusersharehour?access_token="+ this.accessToken;
        return url;
    }
     ...
     * 获取返回对象类
     */
    public Class<GetUserShareHourRespone> getResponseClass(){
        return GetUserShareHourRespone.class;
    }
