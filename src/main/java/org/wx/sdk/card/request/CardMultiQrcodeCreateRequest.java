 ...
 * @version 2017.12.26
 */
public class CardMultiQrcodeCreateRequest implements Request<CardQrcodeCreateRespone> {
	...
	private String action_name = "QR_MULTIPLE_CARD";
	 ...
	 * @param cardList  	 卡券列表
	 */
	public CardMultiQrcodeCreateRequest(List<Card> cardList) {
     ...
     */
    public CardMultiQrcodeCreateRequest(List<Card> cardList, Integer expireSeconds) {
        this.card_list = cardList;
