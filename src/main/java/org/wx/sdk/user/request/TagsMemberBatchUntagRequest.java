 ...
 * @version 2017-02-14
 */
public class TagsMemberBatchUntagRequest implements Request<TagsMemberBatchUntagRespone> {
	/** 微信公众平台唯一凭证 */
     ...
     * @param tagId     	标签ID
     */
    public TagsMemberBatchUntagRequest(List<String> openidList, Integer tagId) {
    ...
    public String getApiUrl(){
        String url = "https://api.weixin.qq.com/cgi-bin/tags/members/batchuntagging?access_token="+ this.accessToken;
        return url;
    }
     ...
     * 获取返回对象类
     */
    public Class<TagsMemberBatchUntagRespone> getResponseClass(){
        return TagsMemberBatchUntagRespone.class;
    }
