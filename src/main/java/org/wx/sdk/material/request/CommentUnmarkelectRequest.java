 ...
 * @version 2017.10.13
 */
public class CommentUnmarkelectRequest implements Request<CommentRespone> {
     ...
     */
    public CommentUnmarkelectRequest(Long msgDataId, Integer index, Integer userCommentId) {
    ...
    public String getApiUrl(){
        String url = "https://api.weixin.qq.com/cgi-bin/comment/unmarkelect?access_token="+ this.accessToken;
        return url;
    }
