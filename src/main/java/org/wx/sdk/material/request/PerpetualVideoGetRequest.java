 ...
 * @version 2016-04-12
 */
public class PerpetualVideoGetRequest implements Request<PerpetualVideoGetRespone> {
     ...
     */
    public PerpetualVideoGetRequest(String mediaId) {
     ...
     * 获取返回对象类
     */
    public Class<PerpetualVideoGetRespone> getResponseClass(){
        return PerpetualVideoGetRespone.class;
    }
