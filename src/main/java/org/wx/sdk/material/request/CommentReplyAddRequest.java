 ...
 * @version 2017.10.13
 */
public class CommentReplyAddRequest implements Request<CommentRespone> {
     ...
     * @param content  回复内容
     */
    public CommentReplyAddRequest(Long msgDataId, Integer index, Integer userCommentId, String content) {
    ...
    public String getApiUrl(){
        String url = "https://api.weixin.qq.com/cgi-bin/comment/reply/add?access_token="+ this.accessToken;
        return url;
    }
    ...
    public Map<String, Object> getWxHashMap(){
        ...
        wxHashMap.put("content", this.content);
        return wxHashMap;
    }
