 ...
 * @version 2017.10.10
 */
public class CommentCloseRequest implements Request<CommentRespone> {
     ...
     */
    public CommentCloseRequest(Long msgDataId, Integer index) {
    ...
    public String getApiUrl(){
        String url = "https://api.weixin.qq.com/cgi-bin/comment/close?access_token="+ this.accessToken;
        return url;
    }
