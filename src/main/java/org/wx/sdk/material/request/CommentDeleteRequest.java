 ...
 * @version 2017.10.13
 */
public class CommentDeleteRequest implements Request<CommentRespone> {
     ...
     */
    public CommentDeleteRequest(Long msgDataId, Integer index, Integer userCommentId) {
    ...
    public String getApiUrl(){
        String url = "https://api.weixin.qq.com/cgi-bin/comment/delete?access_token="+ this.accessToken;
        return url;
    }
