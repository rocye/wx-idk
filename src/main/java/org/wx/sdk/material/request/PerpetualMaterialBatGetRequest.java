 ...
 * @version 2016-06-27
 */
public class PerpetualMaterialBatGetRequest implements Request<PerpetualMaterialBatGetRespone> {
     ...
     */
    public PerpetualMaterialBatGetRequest(String type, Integer offset, Integer count) {
        this.type = type;
        this.offset = offset;
        this.count = count;
    }
     ...
     * 获取返回对象类
     */
    public Class<PerpetualMaterialBatGetRespone> getResponseClass(){
        return PerpetualMaterialBatGetRespone.class;
    }
