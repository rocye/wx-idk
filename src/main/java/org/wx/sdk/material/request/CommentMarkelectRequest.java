 ...
 * @version 2017.10.13
 */
public class CommentMarkelectRequest implements Request<CommentRespone> {
     ...
     */
    public CommentMarkelectRequest(Long msgDataId, Integer index, Integer userCommentId) {
    ...
    public String getApiUrl(){
        String url = "https://api.weixin.qq.com/cgi-bin/comment/markelect?access_token="+ this.accessToken;
        return url;
    }
