...
/**
 * <p>删除群发接口请求对象【订阅号与服务号认证后均可用】
 * <p>1、只有已经发送成功的消息才能删除
 * <p>2、删除消息是将消息的图文详情页失效，已经收到的用户，还是能在其本地看到消息卡片。
 * <p>3、删除群发消息只能删除图文消息和视频消息，其他类型的消息一经发送，无法删除。
 * <p>4、如果多次群发发送的是一个图文消息，那么删除其中一次群发，就会删除掉这个图文消息也，导致所有群发都失效
 * @author Rocye
 * @version 2016-09-29
 */
