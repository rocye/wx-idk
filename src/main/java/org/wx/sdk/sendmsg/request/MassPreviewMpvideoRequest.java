 ...
 * @version 2016-09-30
 */
public class MassPreviewMpvideoRequest extends MassPreviewRequest {
	/** 预览的视频素材 */
    private MediaIdObj mpvideo;
    ...
    public static class Builder {
        ...
        /**
         * 构建模式构建方法
         * @return 构建对象{@link MassPreviewMpvideoRequest}
         */
        public MassPreviewMpvideoRequest build(){
            return new MassPreviewMpvideoRequest(this);
        }
    }
     ...
     * @param builder   构造器
     */
    public MassPreviewMpvideoRequest(Builder builder) {
        super(builder.touser, builder.towxname, builder.msgType);
        this.mpvideo = new MediaIdObj(builder.mediaId);
    }
