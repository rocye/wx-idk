 ...
 * @version 2016-09-30
 */
public class MassPreviewImageRequest extends MassPreviewRequest {
	/** 预览的图像素材 */
    private MediaIdObj image;
    ...
    public static class Builder {
        ...
        /**
         * 构建模式构建方法
         * @return 构建对象{@link MassPreviewImageRequest}
         */
        public MassPreviewImageRequest build(){
            return new MassPreviewImageRequest(this);
        }
    }
     ...
     * @param builder	构建器
     */
    public MassPreviewImageRequest(Builder builder) {
        super(builder.touser, builder.towxname, builder.msgType);
        this.image = new MediaIdObj(builder.mediaId);
    }
