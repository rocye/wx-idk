 ...
 * @version 2016-06-29
 */
public class KfAccountAddRequest implements Request<KfAccountRespone> {
     ...
     */
    public KfAccountAddRequest(String kfAccount, String nickname, String password) {
        this.kf_account = kfAccount;
        this.nickname = nickname;
    ...
    public String getApiUrl(){
        String url = "https://api.weixin.qq.com/customservice/kfaccount/add?access_token="+ this.accessToken;
        return url;
    }
