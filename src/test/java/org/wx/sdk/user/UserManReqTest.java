...
public class UserManReqTest extends TestCase {
    ...
    public void testGroupCreateReq() {
        ...
        //{"errcode":0,"errmsg":"ok"}
        assertTrue(userUpdateRemarkRes.getErrcode() == 0);
    }
    ...
    public void testUserInfoReq() {
        ...
        assertTrue(userInfoRes.getErrcode() == 0);
    }
    ...
    public void testUserInfoBatchGetReq() {
        ...
        assertTrue(userInfoBatchGetRes.getErrcode() == 0);
    }
    ...
    public void testUserListGetReq() {
        ...
        assertTrue(userListGetRes.getErrcode() == 0);
    }
